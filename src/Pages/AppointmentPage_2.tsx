      ...
      <div className="w-full">
        ...
        <div className="w-130 border rounded-lg p-4 flex gap-4 border-[#E7E4E4] bg-white">
          <div className="flex gap-3">
            ...
            <button
              className="flex fontOutfit font-medium text-white gap-2.5 py-3 px-8 flex-1 text-nowrap rounded-lg bg-[#28574E] text-[16px]"
              type="button"
            >
              Completed (1)
            </button>
        ...
        <div className="w-full mt-10 rounded-xl p-4 flex justify-between border border-[#D7D7D7]">
          ...
          <div className="flex flex-col items-end gap-7">
            {/* Confirm badge */}
            <span className="text-[16px] text-[#28574E] fontOutfit font-medium bg-[#E0F8F3] px-3.5 py-2.5 rounded-[20px]">
              Completed
            </span>

            {/* Buttons row */}
            <div className="flex items-center gap-4">
              <button className="fontOutfit font-medium text-[18px] bg-[#28574E] text-white px-8 py-3.5 rounded-lg border border-[#28574E] hover:bg-white hover:text-[#28574E]">
                View Summary
              </button>

              <div className="flex gap-2">
                <button className="fontOutfit font-medium text-[18px] text-[#28574E] px-8 py-3.5 border border-[#28574E] hover:bg-[#28574E] hover:text-white rounded-lg">
                  Book Follow-Up
                </button>
              </div>
            </div>
