...
import BrainImg from "../assets/icon-park-outline_brain.svg";
import BrainImage from "../assets/BrainImg.svg";
    ...
    <div className="flex flex-col rounded-lg border border-[#28574E] w-120 h-236.5 mx-auto m-10">
      <div className="flex gap-54 p-7">
        <div className="flex gap-3">
          <img className="w-7.5 h-[27.52px] " src={BrainImg} alt="BrainImg" />
          <h1 className="fontLibre font-semibold text-[32px] leading-none text-[#28574E] tracking-normal">
            Neurology
          </h1>
        </div>
      ...
      <div className="rounded-[15px] mx-auto mt-5 mb-5">
        <img className="w-105.75 h-54.25" src={BrainImage} alt="" />
      </div>
      <div className="flex flex-col gap-2 ml-7">
        <h1 className="fontOutfit font-medium text-[20px] text-[#28574E] leading-none tracking-normal">
          Department Overview
        </h1>
        <p className="fontOutfit mb-5 font-light text-[#3F484A] text-[18px] leading-6 tracking-normal w-107">
          The Neurology Department focuses on diagnosing and treating disorders
          of the brain, spine, and nervous system. It provides specialized care
          for conditions that affect movement, thinking, memory, and sensation.
        </p>
      </div>
      ...
      <div className="flex flex-col ml-7 gap-4.5">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex gap-3">
            ...
            />
            <p className="fontOutfit font-normal text-[18px] ">
              Nerve disorder diagnosis and care
            </p>
          </div>
          <div className="flex gap-3">
            <input
